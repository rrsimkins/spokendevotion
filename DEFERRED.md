...
## Prayers to the Father I — Streaming
Album uploaded to DistroKid. Pre-sales are open now; full release **July 3, 2026** on Spotify, Apple Music, and other platforms. Pre-save link lives in `partials/streaming-config.js` (update if your DistroKid HyperFollow slug differs). After release, add direct Spotify/Apple album URLs to the site.
